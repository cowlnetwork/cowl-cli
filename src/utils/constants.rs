...
const DEFAULT_CEP_18_INSTALL_PAYMENT_AMOUNT: &str = "275000000000"; // 275 CSPR
const DEFAULT_VESTING_INSTALL_PAYMENT_AMOUNT: &str = "275000000000"; // 275 CSPR
const DEFAULT_VESTING_UPDATE_PAYMENT_AMOUNT: &str = "260000000000"; // 200 CSPR
const DEFAULT_SWAP_INSTALL_PAYMENT_AMOUNT: &str = "290000000000"; // 290 CSPR
const DEFAULT_VESTING_CALL_PAYMENT_AMOUNT: &str = "350000000"; // 0.35 CSPR
const DEFAULT_SET_MODALITIES_CALL_PAYMENT_AMOUNT: &str = "1700000000"; // 1.7 CSPR
...
pub static COWL_VESTING_UPDATE_PAYMENT_AMOUNT: Lazy<String> = Lazy::new(|| {
    env::var("COWL_VESTING_UPDATE_PAYMENT_AMOUNT")
        .unwrap_or_else(|_| DEFAULT_VESTING_UPDATE_PAYMENT_AMOUNT.to_string())
});

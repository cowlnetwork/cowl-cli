...
pub const DEFAULT_COWL_SWAP_COWL_TO_CSPR_SESSION: &str = "cowl_to_cspr_session";
pub const DEFAULT_COWL_SWAP_CSPR_TO_COWL_SESSION: &str = "cspr_to_cowl_session";
...
const DEFAULT_COWL_SWAP_INSTALL_PAYMENT_AMOUNT: &str = "300000000000"; // 300 CSPR
const DEFAULT_COWL_VESTING_CALL_PAYMENT_AMOUNT: &str = "350000000"; // 0.35 CSPR
const DEFAULT_COWL_SET_MODALITIES_CALL_PAYMENT_AMOUNT: &str = "1200000000"; // 1.2 CSPR
...
const DEFAULT_COWL_DEPOSIT_CSPR_CALL_PAYMENT_AMOUNT: &str = "3000000000"; // 3 CSPR
const DEFAULT_COWL_WITHDRAW_COWL_CALL_PAYMENT_AMOUNT: &str = "1500000000"; // 1.5 CSPR
const DEFAULT_COWL_WITHDRAW_CSPR_CALL_PAYMENT_AMOUNT: &str = "3000000000"; // 3 CSPR
const DEFAULT_COWL_CSPR_TO_COWL_CALL_PAYMENT_AMOUNT: &str = "4100000000"; // 4.1 CSPR
const DEFAULT_COWL_COWL_TO_CSPR_CALL_PAYMENT_AMOUNT: &str = "1500000000"; // 1.5 CSPR
const DEFAULT_COWL_UPDATE_TIMES_CALL_PAYMENT_AMOUNT: &str = "500000000"; // 0.5 CSPR
...
pub static COWL_VESTING_INSTALL_PAYMENT_AMOUNT: Lazy<String> = Lazy::new(|| {
    env::var("COWL_VESTING_INSTALL_PAYMENT_AMOUNT")
        .unwrap_or_else(|_| DEFAULT_COWL_VESTING_INSTALL_PAYMENT_AMOUNT.to_string())
});
...
pub static COWL_CSPR_TO_COWL_CALL_PAYMENT_AMOUNT: Lazy<String> = Lazy::new(|| {
    env::var("COWL_CSPR_TO_COWL_CALL_PAYMENT_AMOUNT")
        .unwrap_or_else(|_| DEFAULT_COWL_CSPR_TO_COWL_CALL_PAYMENT_AMOUNT.to_string())
});

pub static COW_COWL_TO_CSPR_CALL_PAYMENT_AMOUNT: Lazy<String> = Lazy::new(|| {
    env::var("COWL_COWL_TO_CSPR_CALL_PAYMENT_AMOUNT")
        .unwrap_or_else(|_| DEFAULT_COWL_COWL_TO_CSPR_CALL_PAYMENT_AMOUNT.to_string())
});

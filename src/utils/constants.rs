...
const DEFAULT_COWL_WITHDRAW_CALL_PAYMENT_AMOUNT: &str = "1500000000"; // 1.5 CSPR
...
pub static COWL_WITHDRAW_CALL_PAYMENT_AMOUNT: Lazy<String> = Lazy::new(|| {
    env::var("COWL_WITHDRAW_CALL_PAYMENT_AMOUNT")
        .unwrap_or_else(|_| DEFAULT_COWL_WITHDRAW_CALL_PAYMENT_AMOUNT.to_string())
});
